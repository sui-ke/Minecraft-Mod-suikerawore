...
public class ObtainOresC {
    public static void Obtain() {
        addList("oreLithium", RawOD.oreLithium);
        addList("oreThorium", RawOD.oreThorium);
        addList("oreBoron", RawOD.oreBoron);
    }
    ...
    public static void addList(String oreName, Set<IBlockState> oreList) {
        ...
        if (blockList != null && !blockList.isEmpty()) {
            for (ItemStack blockStack : blockList) {
                ...
                /*本类矿石列表*/RawOD.oreStoneC.add(block.getStateFromMeta(meta));
