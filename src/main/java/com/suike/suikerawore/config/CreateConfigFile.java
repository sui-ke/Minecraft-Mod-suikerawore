...
import com.suike.suikerawore.config.GetConfig;
...
public class CreateConfigFile {
    public static void config(FMLPreInitializationEvent event) {
        ...
        if (!haveConfig || needUpdate) {
            //从资源路径中复制默认配置文件
            try (InputStream input = CreateConfigFile.class.getResourceAsStream("/assets/suikerawore/blockstates/sui_ke.cfg")) {
        ...
        if (needUpdate) {
            ...
            //总控制
                ...
                /*粗矿掉落数量*/newConfigContent = updateConfigValue(newConfigContent, backupConfigContent, "rawBlockSmelt");
            ...
            //联动
                ...
                /*致密矿石*/newConfigContent = updateConfigValue(newConfigContent, backupConfigContent, "DenseRawOreDrop");
