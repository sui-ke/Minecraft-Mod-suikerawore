...
public class FluidRecipe {
    public static void register() {
        ...
        /*镭熔液*/register(ItemBase.RAW_IRRADIUM, "liquidirradium");
        /*镭熔液*/register(BlockBase.RAW_BLOCK_IRRADIUM, "liquidirradium");
        /*钯熔液*/register(ItemBase.RAW_PALLADIUM, "palladium_fluid");
        /*钯熔液*/register(BlockBase.RAW_BLOCK_PALLADIUM, "palladium_fluid");
