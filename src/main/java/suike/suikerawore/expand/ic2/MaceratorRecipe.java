...
//配方注册
    public static void register(Item input, String outputOD) {
        ...
        int amount = 1;
        if (outputOD.startsWith("crushed")) {
            amount = ConfigValue.maceratorCrushedOutputAmount;
        } else if (outputOD.startsWith("dust")) {
            amount = ConfigValue.maceratorDustOutputAmount;
        }
