...
public class blockMakeRaw {
    public static void register() {
        ...
        /*粗铍*/register(BlockBase.RAW_BLOCK_BERYLLIUM, ItemBase.RAW_BERYLLIUM);
        /*粗镭*/register(BlockBase.RAW_BLOCK_IRRADIUM, ItemBase.RAW_IRRADIUM);
        /*粗钯*/register(BlockBase.RAW_BLOCK_PALLADIUM, ItemBase.RAW_PALLADIUM);
        /*粗钚*/register(BlockBase.RAW_BLOCK_PLUTONIUM, ItemBase.RAW_PLUTONIUM);
        /*粗秘银*/register(BlockBase.RAW_BLOCK_MITHRIL, ItemBase.RAW_MITHRIL);
        /*粗金红石*/register(BlockBase.RAW_BLOCK_RUTILE, ItemBase.RAW_RUTILE);
