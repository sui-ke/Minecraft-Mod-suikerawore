...
public class AddRawOre {
    public static void oreDictAdd() {
        ...
        /*铍*/oreDictAdd("Beryllium", ItemBase.RAW_BERYLLIUM);
        /*镭*/oreDictAdd("Irradium", ItemBase.RAW_IRRADIUM);
        /*钯*/oreDictAdd("Palladium", ItemBase.RAW_PALLADIUM);
        /*钚*/oreDictAdd("Plutonium", ItemBase.RAW_PLUTONIUM);
        /*铌*/oreDictAdd("Niobium", ItemBase.RAW_NIOBIUM);
        /*秘银*/oreDictAdd("Mithril", ItemBase.RAW_MITHRIL);
        /*金红石*/oreDictAdd("Rutile", ItemBase.RAW_RUTILE);
