...
public class AddRawBlock {
    public static void oreDictAdd() {
        ...
        /*铍*/oreDictAdd("Beryllium", BlockBase.RAW_BLOCK_BERYLLIUM);
        /*镭*/oreDictAdd("Irradium", BlockBase.RAW_BLOCK_IRRADIUM);
        /*钯*/oreDictAdd("Palladium", BlockBase.RAW_BLOCK_PALLADIUM);
        /*钚*/oreDictAdd("Plutonium", BlockBase.RAW_BLOCK_PLUTONIUM);
        /*铌*/oreDictAdd("Niobium", BlockBase.RAW_BLOCK_NIOBIUM);
        /*秘银*/oreDictAdd("Mithril", BlockBase.RAW_BLOCK_MITHRIL);
        /*金红石*/oreDictAdd("Rutile", BlockBase.RAW_BLOCK_RUTILE);
