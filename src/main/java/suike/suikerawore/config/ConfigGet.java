...
public class ConfigGet {
    ...
    public static void loadMainConfig() {
        ...
        ConfigValue.DenseRawOreDrop = readConfig("rawOre", "MoreRawOreDrop", true);

        //IC2
        ConfigValue.maceratorCrushedOutputAmount = readConfig("CrossMod.IC2", "maceratorCrushedOutputAmount", 1);
        ConfigValue.maceratorDustOutputAmount = readConfig("CrossMod.IC2", "maceratorDustOutputAmount", 1);

        //工业2经典版
        ConfigValue.IC2ClassicMaceratorRawOreOutputAmount = readConfig("CrossMod.IC2Classic", "IC2ClassicMaceratorRawOreOutputAmount", 1);
        ConfigValue.IC2ClassicMaceratorIngotOutputAmount = readConfig("CrossMod.IC2Classic", "IC2ClassicMaceratorIngotOutputAmount", 1);
