...
public class ConfigValue {
    // 配置文件版本
    public static final int modsConfigVersion = 20; // 配置文件版本
    public static final int rawOreListVersion = 4; // 粗矿列表文件版本
    ...
    public static int maceratorRawOutputAmount = 1; // 打粉机碎块输出量
        // 格雷科技
    public static int gregTechCrushedOutputAmount = 1; // 格雷科技粉碎矿输出
        // 通用机械
