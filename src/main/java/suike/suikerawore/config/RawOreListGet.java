...
public class RawOreListGet {
    public static void config() {
        ...
        try {
            ...
            for (String key : keys) {
                ...
                boolean value = readConfig(new Configuration(configFile), key, false);
    ...
    public static boolean readConfig(Configuration config, String key, boolean defaultValue) {
        return config.get("rawOreList", key, (Boolean) defaultValue).getBoolean();
    }
}