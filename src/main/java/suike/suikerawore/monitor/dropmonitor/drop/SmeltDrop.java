...
public class SmeltDrop {
    ...
    public static void addSmelt() {
        ...
        add("raw_vanadium", ItemBase.INGOT_VANADIUM);//钒
        add("raw_cadmium", ItemBase.INGOT_CADMIUM);//镉
        add("raw_manganese", ItemBase.INGOT_MANGANESE);//锰
        add("raw_germanium", ItemBase.INGOT_GERMANIUM);//锗
        add("raw_chromium", ItemBase.INGOT_CHROMIUM);//铬
        add("raw_arsenic", ItemBase.INGOT_ARSENIC);//砷
        ...
        add("raw_rosegold", "mca:rose_gold_ingot", 0);//玫瑰金
    }
